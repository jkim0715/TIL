...
- .do라고 하면 DispatcherServlet으로 이동 하겠다는 말임.



day14 변경사항

- 기존 day1333에서 req대신 dispatcher/ .do를 이용
- 페이지 전체를 이동하는 대신 center_div안에서 움직이도록 설정.
  - include 된 page는 main에서 style을 변경 가능.
  - 좀더 분류를 함으로서  역할 분담을 할 수 있게 변경.
...
User 와 Product CRUD를 완성하시오 



2.Bootstrap 

Admin Theme 을 이용하여 화면을 구현 한다.
